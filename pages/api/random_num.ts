...
export default function (req: NextApiRequest, res: NextApiResponse) {
  ...
  // RES
  res.setHeader('X-Custom-Header', 'we are open to new hires')  // set a custom Header
  ...
  console.log('---')
  console.log('REQUEST query', req.query) // this data will return after page loads up
  console.log('---')
  console.log('REQUEST body', req.body) // this data only returns after a FETCH() is made
  console.log('---')
